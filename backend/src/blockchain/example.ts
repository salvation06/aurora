...
import { AlbumNFTMinter, AlbumMasterData, createMasterAlbumCollection } from './album-nft.js';
...
async function exampleCreateAndMint() {
  ...
  try {
    ...
    const collection = await minter.createCollection(
      ...
      'Test collection for Aurora Master CD NFTs'
    );
 ...
 */
async function exampleMintToExisting(collectionId: number) {
 ...
 */
async function exampleListNFTs(collectionId: number) {
